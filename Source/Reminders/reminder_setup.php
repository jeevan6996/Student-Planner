...
<?php
    ...
    if(isset($_POST["submit"]))
	{
		...
		if( empty( $error_list ) )
		{
			...
			$insert_Query=( "INSERT INTO reminder_events(reminder_name,reminder_desc,reminder_date) VALUES('".addslashes($_POST['reminder_name'])."', '".addslashes($_POST['reminder_desc'])."', '".addslashes($reminder_date)."')" );
...
reminder_id int(20)  NOT NULL auto_increment PRIMARY KEY,
reminder_name varchar(100) NOT NULL default '',
reminder_desc varchar(250),
